...
public class MQTTActivity extends Activity implements OnClickListener{
    ...
    public void setupView()
    {
    	...
    	addressET.setText("tcp://localhost:1883", android.widget.TextView.BufferType.EDITABLE);
    	userNameET = (EditText)findViewById(R.id.userNameEditText);
    	userNameET.setText("username", android.widget.TextView.BufferType.EDITABLE);
    	passwordET = (EditText)findViewById(R.id.passwordEditText);
    	passwordET.setText("password", android.widget.TextView.BufferType.EDITABLE);
    	destinationET = (EditText)findViewById(R.id.destinationEditText);
    	destinationET.setText("topic", android.widget.TextView.BufferType.EDITABLE);
